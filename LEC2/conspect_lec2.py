...
# Суммирование значений (и другие аггрегатные функции)
...
# # 2. Если формы массивов не совпадают в каком-то измерении, то если у массива форма равна 1,
# # то он "растягивается" до соответствия формы второго массива
# # 3. Если после применения этих правил в каком-либо измерении размеры отличаются и ни один из них
# # не равен единице, то мы не можем сделать транслирование - генерируется ошибка
#
# # a = np.array([[0,1,2], [3,4,5]])
# # b = np.array([5])
# #
...
# # & | ^  ~
#
# #2. Пример для y. Вычислить количество элемементов по обоим размерностям,
